...
var _game = {
    ...
    _func_gameOver:function(data){
        console.log(data);
    },
    _func_gameStatus:function(data){
        console.log(data);
        clearInterval(gametime);
        this.endFn();
    },
    ...
    settime:function(countdown){
        ...
        if(countdown>=3&&countdown<6){
            //动画，缩放，发牌
            this.zoomFn(countdown);
            // console.log(countdown);
        }
        if(countdown>=6&&countdown<44){
            //押注时间
            this.zoomFn(countdown);
        ...
        if(countdown>=44&&countdown<47){
            //准备揭晓结果
            this.readyFn(countdown);
            // console.log(countdown);
        }
        if(countdown>=47&&countdown<50){
            //翻牌
        ...
        if(countdown>=50&&countdown<53){
            //比牌大小，揭晓结果
            this.resultFn(biggest_cards);
            // console.log(countdown);
        }
        if(countdown>=53&&countdown<=55){
            //回到准备开始游戏
            this.endFn();
            // console.log(countdown);
        }
