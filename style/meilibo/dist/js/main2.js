...
function connectChange(){
    ...
    myPlayer.on('play', function() {  
        ...
        if(pla==1){
            var html='<div id="roomtitle" class="roomtitle">'+Anchor.nickname+'的直播间</div>';
        ...
        if(Math.abs(deltaX) > Math.abs(deltaY) && deltaX > 50){
            ...
            if(User){
                if(!$(".section1_box").hasClass("animate")){
                    ...
                    $(".game_task .small_xx i").css({"bottom":"410px","right":"20px;"});
                }
            }
            ...
            if(User){
                if($(".section1_box").hasClass("animate")){
                    ...
                    $(".game_task .small_xx i").css({"bottom":"210px","right":"20px"});
                }
            }
