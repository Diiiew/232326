...
var _chat = {
    ...
    show_message: function(nickName,msg,level,showType,msg_type,user_id ) {
        ...
        var _msg = '';
        if(msg_type==0){
                _msg = '<p><label class ="user_nickname" user_id='+user_id+'><img src="/style/meilibo/dist/images/level/public_icon_vip'+level+'@2x.png" style="margin-bottom: -2px;margin-right:2px;" width="25" height="12" >'+nickName+'</label> : <font color="'+color+'">'+msg+'</font></p>'  
        }else if(msg_type == 1) {
                _msg = '<p><label class ="user_nickname" user_id='+user_id+'><img src="/style/meilibo/dist/images/level/public_icon_vip'+level+'@2x.png" style="margin-bottom: -2px;margin-right:2px;" width="25" height="12" >'+nickName+'</label> : <font color="'+color+'">'+msg+'</font></p>'  
        } else if(msg_type == 2) {
